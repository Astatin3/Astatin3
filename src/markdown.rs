...
pub fn Markdown(props: MdProps) -> Element {
    ...
    rsx! {
        document::Link { rel: "stylesheet", href: asset!("/assets/styling/markdown_theme_dark.css") },
        document::Script {
            src: asset!("/assets/scripts/links.js")
        },
        document::Style {
...
// use crate::dioxus_elements::input::{disabled, readonly};
...
//             }
//             HtmlElement::Heading(1) => {
//                 rsx! {h1 {onclick: onclick, style: "{style}", class: "linkable {class}",
//                     {inside}
//                 }}
//             }
//             HtmlElement::Heading(2) => {
